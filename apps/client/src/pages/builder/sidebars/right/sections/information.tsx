  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built CvOnline mostly by myself during my spare time, with a lot of help from other
    ...
    <CardFooter>
      ...
      >
        ...
        <span className="line-clamp-1">{t`Donate to CvOnline`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for CvOnline, and I'm
