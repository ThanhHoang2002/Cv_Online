      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using CvOnline, you agree to
        ...
        <li>
          ...
          <p>
            CvOnline is committed to ensuring the security of your data. Our application and
